...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="padding100" style="margin-top:10%; margin-bottom:13%">
        <div class="container">
            <div id="loginbox" style="margin-top: 3%;"  class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
